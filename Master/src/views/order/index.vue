  ...
  <div>
    ...
    <div class="main w block-center">
      ...
      <div class="main-content-right order-list">
        <OrderEvaluate v-if="!comm.IsNullOrEmpty(tagData.evaluate)" :visible.sync="tagData.evaluate.visible" :order="tagData.evaluate.id" @successEvent="opClick('evaluateSuccess')" @closeEvent="opClick('evaluateExit')"></OrderEvaluate>
